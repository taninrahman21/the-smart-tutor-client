...
const ServiceDetails = () => {
  ...
  return (
    <div className='w-5/6 mx-auto mt-8'>
      ...
      <p className='text-2xl font-semibold mt-6'>About Service: {description}</p>
      <div>
        <p>Public Reviews</p>

      </div>
      <div>         
         <button type="button" className="focus:outline-none text-white bg-[#9c380c] hover:bg-[#912f06] font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">Login to add a review</button>
      </div>
...
<form>
   <div className="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
       <div className="py-2 px-4 bg-white rounded-t-lg dark:bg-gray-800">
           ...
           <textarea id="comment" rows="4" className="px-0 w-full text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write your massage..." required=""></textarea>
       </div>
...
<p className="ml-auto text-xs text-gray-500 dark:text-gray-400">Remember, contributions to this topic should follow our <a href="#ta" className="text-blue-600 dark:text-blue-500 hover:underline">Community Guidelines</a>.</p>
