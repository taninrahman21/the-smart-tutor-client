  ...
  return (
    <div className='bg-gray-100'>
      ...
      <div className='flex flex-col justify-center ml-10 w-[45%]'>
        ...
        <div className='mt-10'>
          <Link to='/contact'>
          <button type="button" className="focus:outline-none text-white bg-[#3f6c51] hover:bg-[#365e45] focus:ring-4 focus:ring-red-300 font-medium text-base px-5 py-2.5 mr-8">Contact Me</button>
          </Link>
          <Link to='/about'>
